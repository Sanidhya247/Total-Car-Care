...
<head>
    ...
    <meta charset="utf-8" />
    <title>Blank Page - Total Car Care Admin
        ...
        <div class="navbar-container ace-save-state" id="navbar-container">
            ...
            <div class="navbar-header pull-left">
                <a href="index.html" class="navbar-brand">
                    ...
                    <span class="white" id="id-text2">Car Care Admin</span>
                    <!-- </small> -->
                </a>
            </div>
                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="light-blue dropdown-modal">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <?php
								$pic=$_SESSION['pic'];
								echo "<img class='nav-user-photo' src='admin_photo/$pic' />";
								?>
            ...
            <ul class="nav nav-list">
                ...
                <li class="">
                    <a href="#" class="dropdown-toggle">
                        ...
                        <span class="menu-text"> Manage Parts </span>
                ...
                <li class="">
                    <a href="#" class="dropdown-toggle">
                        ...
                        <span class="menu-text"> Manage Accessories </span>
                    ...
                    <ul class="submenu">
                        <li class="">
                            <a href="car_accessories_master.php">
                                <i class="menu-icon fa fa-caret-right"></i>
                                car_accessories_master
                            </a>
                        ...
                        <li class="">
                            <a href="car_accessories_details.php">
                                <i class="menu-icon fa fa-caret-right"></i>
                                car_accessories_details
                            </a>
                ...
                <li class="">
                    <a href="manage_vendor.php">
                        ...
                        <!-- <i class="menu-icon fa fa-address-book" aria-hidden="true"></i> -->
                ...
                <li class="">
                    <a href="manage_booking.php">
                        ...
                        <span class="menu-text"> Manage Booking </span>
                    </a>
                ...
                <li class="">
                    <a href="manage_testimonials.php">
                        ...
                        <span class="menu-text"> Manage Testimonials </span>
                    </a>
                ...
                <li class="">
                    <a href="manage_contactus.php">
                        <i class="menu-icon fa fa-envelope"></i>
                        <span class="menu-text"> Manage Contact Us </span>
                    </a>
