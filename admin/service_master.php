...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Service_master</li>
						</ul><!-- /.breadcrumb -->
    ...
    <?php
        ...
        if(isset($_POST['submit']))
        {
           ...
           $q=mysqli_query($con,"insert into service_master values('','$sname','$file_name')");
							...
							<div class="col-xs-12">
								...
								<form method="POST" action="" enctype="multipart/form-data" class="form-horizontal" role="form" >
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="sname" id="sname" placeholder="Service_name" class="col-xs-10 col-sm-5" required/>
										</div>
									</div>
	...
	<script>
		function del(sid)
		{
			...
			{
				window.location.href='delete_service_master.php?sid=' +sid+ '';
				return true;
			}
		}
		function edit(sid)
		{
			...
			{
				window.location.href='edit_service_master.php?sid=' +sid+ '';
				//return true;
			}
		}
	</script>										
