...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            $phone=$_POST['phone'];
            $email=$_POST['email'];
            if(isset($_SESSION['acc_total']))
                $acc_total=$_SESSION['acc_total'];
            else
                $acc_total=0;
            
            if(isset($_SESSION['pa_total']))
            ...
            if(isset($_SESSION['pa_qty']))
                $qua=$_SESSION['pa_qty'];
            else
                $qua=0;

            if(isset($_SESSION['acc_qty']))
            ...
            $message = "Welcome to TOTAL CAR CARE !!
            ...
            Parts Subtotal        
            Accessaries Subtotal   
            =============================
           
            Your Cart value is    $total5


            Copyrights by 2022 All Rights Reserved by Total Car Care.
        ...
        mail($to, $subject, $message, $headers) ;
            ...
            echo "insert into order_master values('',$uid,'$uname','$address','$zipcode','$phone','$email','$total5',0)";
            if ($q) {
