...
<body class="img js-fullheight" style="background-image: url(images/car.jpg);">
    ...
    if (isset($_POST['submit'])) {
        ...
        $q=mysqli_query($con,"update user_registration set password='$newpassword' where email='$email'");
        echo "update user_registration set password='$newpassword' where email=$email";
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4">
                        <div class="login-wrap p-0">
                            ...
                            <h6 class="mb-20" style=" margin-left: 24px;">Enter your new password, confirm and submit
                            </h6>
                            <form method="POST" enctype="multipart/form-data" class="signin-form">
                                ...
                                <div class="form-group">
                                    <input type="password" name="conpassword" id="conpassword" class="form-control"
                                        placeholder="Confirm New Password" onchange="chk()" required>
