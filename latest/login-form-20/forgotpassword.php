            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <h6 class="mb-20" style=" margin-left: 24px; margin-bottom: 20px;">Drop Your Registered E-mail
                        </h6>

                        <form method="POST" enctype="multipart/form-data" class="signin-form">
                            <div class="form-group">
                                <input type="text" name="email" placeholder="Enter Registered Email " id="email"
