...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/order-success-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 15:53:52 GMT -->
            ...
            <tr>
                <td>
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;"
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <img src="images/order-image-2.jpg" alt="" style="margin-bottom: 30px; width: 70%;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" align="left"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <img src="images/space.jpg" alt=" " height="25" width="30">
                                </td>
                                <td style="background-color: #eff2f7;padding: 15px;letter-spacing: 0.3px;width: 50%;">
                                    <h5
                                        style="font-size: 16px; font-weight: 600;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #ddd; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left"
                        ...
                        <tr>
                            <td>
                                <img src="images/5.jpg" alt="" width="80" style="margin: 8px 0;">
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="images/6.jpg" alt="" width="80" style="margin: 8px 0;">
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="images/7.jpg" alt="" width="80" style="margin: 8px 0;">
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="images/8.jpg" alt="" width="80" style="margin: 8px 0;">
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                            </td>
...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/order-success-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 15:53:55 GMT -->
