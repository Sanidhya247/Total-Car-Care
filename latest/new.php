...
$to = 'prince.bambhroliya@gmail.com'; 
$from = 'totalcarcare5@gmail.com'; 
$fromName = 'SenderName'; 
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
$subject = "Send HTML Email in PHP by Total Car Care"; 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-block">
                                                        <h2>Thanks for using Total Car Care</h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="content-block">
                                                ...
                                                <tr>
                                                    <td class="content-block">
                                                        <p>Copyrights &copy; 2022 All Rights Reserved by Total Car Care.
                                                        </p>
                                                    </td>
                                                </tr>
