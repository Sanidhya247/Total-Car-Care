...
.home-p.pages-head9 {
  background-image: url(../img/caracc2.png) no-repeat;
...
/* @media(max-width: 991.5px) {
    ...
    .container .row .col-lg-4 {
        ...
        <div id="home-p" class="home-p pages-head9 text-center">
        <div class="container">
            <h1 class="wow fadeInUp" data-wow-delay="0.1s">CAR ACCESSORIES</h1>
            <p>View</p>
        </div>
        <!--/end container-->
        </div>
...
<!-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="height: 450px;">
    ...
    <div class="carousel-inner" style="height:450px;">
        <div class="carousel-item active">
            <img class="d-block w-100" src="../latest/img/caracc2.png" alt="First slide">
        </div>
        <!-- <div class="carousel-item">
            <img class="d-block w-100" src="../latest/img/car.jfif" alt="Second slide">
        </div> 
